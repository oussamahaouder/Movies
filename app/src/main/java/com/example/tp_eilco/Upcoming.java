...
public class Upcoming extends AppCompatActivity implements MoviesAdapter.OnMoviesListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBottomNavigationView=findViewById(R.id.activity_main_bottom_navigation1);
        recyclerView=findViewById(R.id.upcomingmovies);
        ...
        MoviesDbApi moviesDbApi = RetrofitClientUpcoming.getRetrofitUpcoming().create(MoviesDbApi.class);
        ...
        call.enqueue(new Callback<Movies>() {
            ...
            public void onResponse(Call<Movies> call, Response<Movies> response) {
                ...
                for (Movies.data data1 : data) {
                    ...
                    adapter = new MoviesAdapter(data,Upcoming.this,Upcoming.this);
